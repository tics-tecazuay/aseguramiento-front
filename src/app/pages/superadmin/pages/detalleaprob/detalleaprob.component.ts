...
@Component({
  selector: 'app-detalleaprob',
  templateUrl: './detalleaprob.component.html',
  styleUrls: ['./detalleaprob.component.css']
})
export class DetalleaprobComponent implements OnInit {
...
modeloMax() {
  ...
  goBack() {
    this.router.navigate(['/sup/aprobaciones']);
  }
